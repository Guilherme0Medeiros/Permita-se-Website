...
export function ProductCard({ id, nome, preco, descricao, onAddToCart, imagem, onClick }: ProductCardProps) {
  return (
    <div className="group bg-white rounded-b-lg shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-500 max-w-xs border border-gray-100 hover:border-orange-200">
      {/* Área clicável que leva à página do produto */}
      <div onClick={onClick} className="cursor-pointer">
        ...
        {/* Nova div para o conteúdo com padding */}
        <div className="p-6">
          <h3 className="font-bold text-lg text-gray-900 mb-2 group-hover:text-orange-600 transition-colors">
            {capitalizeWords(nome)}
          </h3>
          {descricao && <p className="text-gray-600 text-sm mb-4 line-clamp-2">{descricao.substring(0, 60)}...</p>}
